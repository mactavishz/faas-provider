...
This is a fork of the OpenFaaS provider SDK, which is used to implement back-ends for OpenFaaS. The original code can be found in the [faas-provider](https://github.com/openfaas/faas-provider).
